/*
Measurements need to be checked in initialization code.
Double check this code when running (I was being stupid and forgot to plug in the encoders).
In theory this code is perfect.
Contains all IMU, Encoder, and Time based movement!
*/
